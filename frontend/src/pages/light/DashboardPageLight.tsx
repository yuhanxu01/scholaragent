          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 sm:gap-6 mb-6 sm:mb-8">
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-600">{t('dashboard.documents')}</p>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-600">{t('dashboard.notes')}</p>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-600">{t('dashboard.flashcards')}</p>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-600">{t('dashboard.studyHours')}</p>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <span className="text-gray-700">{t('dashboard.uploadDocument')}</span>
                </button>
                <button
                ...
                >
                  ...
                  <span className="text-gray-700">{t('dashboard.createNote')}</span>
                </button>
                <button
                  onClick={handleAskAI}
                  className="w-full text-left px-4 py-3 border border-gray-200 rounded-lg hover:bg-gray-50 flex items-center"
                >
                  ...
                  <span className="text-gray-700">{t('dashboard.askAIAssistant')}</span>
                </button>
                <button
                ...
                >
                  ...
                  <span className="text-gray-700">管理生词本</span>
                </button>
              </div>
            </div>
          </div>
